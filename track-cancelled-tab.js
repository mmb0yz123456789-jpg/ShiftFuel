...
(function () {
  ...
  const install = function () {
    ...
    window.renderAllRequests = async function (requests, phone, email) {
      ...
      html += '<details class="track-section" open><summary class="track-section-header">Requests in progress <span class="track-section-count">' + inProgress.length + '</span></summary><div class="track-section-body">';

          ...
          <Animated.View style={[styles.card, { transform: [{ translateX: shakeAnim }] }]}>
            <View style={styles.field}>
              ...
              <TextInput
                ...
                placeholder="admin" placeholderTextColor="#A7BFA6"
            ...
            <Pressable
              style={({ pressed }) => [styles.btn, pressed && styles.btnPressed, (submitting || !username || !password) && styles.btnDisabled]}
              onPress={handleLogin} disabled={submitting || !username.trim() || !password}
            >
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: "#062727" },
  kav: { flex: 1 },
  inner: { flex: 1, paddingHorizontal: 24, justifyContent: "center" },
  back: { marginBottom: 24 },
  backText: { fontSize: 15, fontFamily: "Inter_600SemiBold", color: "#A7BFA6" },
  header: { alignItems: "center", marginBottom: 32 },
  iconWrap: { width: 64, height: 64, borderRadius: 20, backgroundColor: "rgba(255,107,90,0.15)", borderWidth: 1.5, borderColor: "rgba(255,107,90,0.3)", alignItems: "center", justifyContent: "center", marginBottom: 14 },
  icon: { fontSize: 28 },
  ...
  card: { backgroundColor: "#FFFFFF", borderRadius: 20, padding: 22, shadowColor: "#000", shadowOffset: { width: 0, height: 12 }, shadowOpacity: 0.25, shadowRadius: 20, elevation: 10 },

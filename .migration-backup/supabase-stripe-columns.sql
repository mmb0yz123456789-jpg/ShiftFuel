-- ============================================================
-- supabase-stripe-columns.sql
-- Adds Stripe payment tracking columns to service_requests.
-- Run after supabase-request-rpc-fixes.sql
-- ============================================================
...
-- Allow admin_update_request to set payment fields.
-- This replaces the existing function — only payment_intent_id and
-- payment_status CASE blocks are added; everything else is unchanged.

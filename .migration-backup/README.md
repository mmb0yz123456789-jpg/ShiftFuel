...
- `archive/sql/`: historical SQL patches kept for reference only.
...
Root-level `supabase-*.sql` files and files under `archive/sql/` are historical/manual patches and should not be treated as the current migration path.

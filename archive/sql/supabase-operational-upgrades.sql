...
-- Prevent two accepted-or-later requests from taking the same service date and return slot.
-- request_received stays available until admin accepts the request.
